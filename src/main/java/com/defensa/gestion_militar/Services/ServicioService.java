...
public class ServicioService {
    ...
    public ServiciosDTO obtenerServicioPorId(Long idAdmin,Long idServicio){
    ...
    public void guardarServicio(Long idAdmin,ServiciosDTO dto) {
...
//        repo_serv.save(entidad);
    ...
    // ELIMINAR
    public void eliminarServicio(Long idAdmin,Long id) {
...
//        repo_serv.deleteById(id);
    ...
    public void editarServicio(Long idAdmin,Long idServicio,ServiciosDTO dto){
