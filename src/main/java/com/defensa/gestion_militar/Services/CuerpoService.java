...
public class CuerpoService {
    ...
    public CuerpoDTO obtenerCuerpoPorId(Long idAdmin,Long idCuerpo){
    ...
    public void eliminarCuerpo(Long idAdmin,Long id){
...
//        repoCuerpos.deleteById(id);
    ...
    public void guardarCuerpo(Long idAdmin,CuerpoDTO dto) {
...
//        repoCuerpos.save(entidad);
    ...
    public void editarCuerpo(Long idAdmin,Long idCuerpo, CuerpoDTO dto) {
