...
public class Oficial extends Usuario implements CapacidadOficial {
    ...
    @Override
    public void consultarCuartel(Long idCuartel) {
        if (idCuartel <= 0) {
            throw new RuntimeException("El identificador del cuerpo para la consulta es inválido.");
        }
    ...
    @Override
    public void consultarUsuario(Long idUsuario) {
        if (idUsuario <= 0) {
            throw new RuntimeException("El identificador del cuerpo para la consulta es inválido.");
        }
    ...
    @Override
    public void consultarCuerpo(Long idCuerpo) {
        if (idCuerpo <= 0) {
            throw new RuntimeException("El identificador del cuerpo para la consulta es inválido.");
        }
    ...
    @Override
    public void consultarServicio(Long idServicio) {
        if (idServicio <= 0) {
            throw new RuntimeException("El identificador del cuerpo para la consulta es inválido.");
        }
