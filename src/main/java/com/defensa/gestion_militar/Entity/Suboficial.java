...
public class Suboficial extends Usuario implements CapacidadSuboficial {
    ...
    @Override
    public void consultarCuartel(Long idCompania) {
    ...
    @Override
    public void consultarCuerpo(Long idCompania) {
    ...
    @Override
    public void consultarServicio(Long idCompania) {
    ...
    @Override
    public void consultarUsuario(Long idCompania) {
